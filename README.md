...
│ --with-wdu                     -w            Enable Watson Document Understanding service for document conversion. Allows the agent to process and extract text from files such as PDF, Word, and PowerPoint, converting them into     │
│                                              readable textual formats like plain text or markdown.                                                                                                                                     │
