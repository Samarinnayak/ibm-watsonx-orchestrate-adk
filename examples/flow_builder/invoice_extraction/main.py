...
from examples.flow_builder.invoice_extraction.tools.invoice_extraction_flow import build_docproc_flow
...
async def main():
    ...
    my_flow_definition.dump_spec(f"{generated_folder}/docproc_invoice_spec.json")
    global flow_run
