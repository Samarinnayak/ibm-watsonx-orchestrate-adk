...
from examples.flow_builder.hello_message_script_flow.tools.hello_message_script_flow import build_hello_message_script_flow
...
async def main():
    ...
    my_flow_definition = await build_hello_message_script_flow().compile_deploy()
