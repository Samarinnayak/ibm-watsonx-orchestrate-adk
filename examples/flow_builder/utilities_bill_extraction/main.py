...
from examples.flow_builder.utilities_bill_extraction.tools.utilities_bill_extraction_flow import build_docproc_flow
...
async def main():
    ...
    my_flow_definition.dump_spec(f"{generated_folder}/docproc_utilities_spec.json")
    global flow_run
